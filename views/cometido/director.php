...
$this->title = 'Listado de Cometidos por Autorizar';
                    ...
                    [
                        ...
                        'buttons' => [
                            'link' => function ($url, $model, $key) {
                                if ($model['estado'] == '1') {
                                    return Html::a('<a class="btn btn-success" href="index.php?r=cometido/autorizar&id=' . $model['id_cometido'] . '">Autorizar</a>')
                                        . Html::a('<a class="btn btn-danger" href="index.php?r=cometido/denegar&id=' . $model['id_cometido'] . '">Denegar</a>');
                                }
                            },
